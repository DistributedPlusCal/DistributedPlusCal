...
//        else  result1.addElement(UpdatePC(next));
    ...
    ***********************************************************************/
    ...
    private static Vector CopyAndExplodeLastStmt(Vector stmts, String next, Integer threadIndex) throws PcalTranslateException {
        /**************************************************************
        * The arguments are:                                               *
        *                                                                  *
        *    stmts : a (perhaps null) Vector of statements                 *
...
//        else  result1.addElement(UpdatePC(next));
    ...
    private static Vector CopyAndExplodeLastStmtWithGoto(Vector stmts, String next, Integer threadIndex) throws PcalTranslateException {
    	/*********************************************************************
    	 * Added by LL on 5 Feb 2011: The following comment seems to be       *
    	 * wrong, and the method adds a goto iff the 3rd element of the       *
    	 * value returned by CopyAndExplodeLastStmt equals true.              *
    ...
    private static Vector ExplodeLabeledStmt (AST.LabeledStmt ast,
    		String next, Integer threadIndex) throws PcalTranslateException {
    	/******************************************************************
    	 * label SL -->                                                    *
    	 * label when pc = "label" ;                                       *
    	 *       SL                                                        *
    ...
    private static Vector ExplodeLabelIf(AST.LabelIf ast, String next, Integer threadIndex) throws PcalTranslateException {
        /***************************************************************
         *       test unlabThen labThen unlabElse labElse next -->     *
         *       if test then                                          *
         *          unlabThen                                          *
    ...
    * newly created statements for error reporting.                        
     **
    ***********************************************************************/
    private static Vector ExplodeCall(AST.Call ast, String next, Integer threadIndex) throws PcalTranslateException {
        Vector result = new Vector();
        int to = st.FindProc(ast.to);
        /*******************************************************************
        * Error check added by LL on 30 Jan 2006 to fix bug_05_12_10.      *
    ...
    * newly created statements for error reporting.                        
     **
    ***********************************************************************/
    private static Vector ExplodeCallReturn(AST.CallReturn ast, String next, Integer threadIndex) throws PcalTranslateException {
        Vector result = new Vector();
        /*******************************************************************
        * The following test for a return not in a procedure was added by  *
        * LL on 30 Mar 2006.  This error isn't caught by the parsing       *
    ...
    * goto.                                                                *
    ***********************************************************************/
    private static Vector ExplodeCallGoto(AST.CallGoto ast, String next, Integer threadIndex) throws PcalTranslateException {
      AST.Call call = new AST.Call();
      call.to = ast.to;
      call.args = ast.args;
      call.line = ast.line;
