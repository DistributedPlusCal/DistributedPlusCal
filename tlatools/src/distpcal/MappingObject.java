...
public class MappingObject implements Serializable {
    ...
    public static class LeftParen extends MappingObject {
		...
		//        private int column ;
        private DistPCalLocation location ;
        public LeftParen(DistPCalLocation location) {
           super(LEFT_PAREN) ;
//           this.column = column;
...
//        }
        ...
        public DistPCalLocation getLocation() {
            return location;
        }
    ...
    public static class RightParen extends MappingObject {
		...
		//        private int column ;
        private DistPCalLocation location ;
        public RightParen(DistPCalLocation location) {
           super(RIGHT_PAREN) ;
//           this.column = column;
           this.location = location;
        }
