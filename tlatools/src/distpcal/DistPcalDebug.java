...
import distpcal.exception.UnrecoverablePositionedException;
import pcal.AST;
import util.ToolIO;
...
public class DistPcalDebug
{
     ...
     */
    public static void reportError(String message, distpcal.AST ast)
    {
    ...
    *********************************************************************/
    {
    	final StringBuilder sb = new StringBuilder("You have discovered a bug in distpcal.trans.\n");
