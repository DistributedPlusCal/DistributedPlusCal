...
\begin{frame}[fragile]{Comparison through Lamport Mutex Algorithm}
...
\begin{frame}[fragile]{Lamport Mutex in PlusCal}
...
\begin{frame}[fragile]{Comparison in terms of communication channels}
...
\begin{frame}[fragile]{Communication Channel Translation}
    \begin{itemize}
...
\begin{frame}[fragile]{Sub-Processes Translation}
    \begin{itemize}
     \item The special variable $pc$ was modified to have be initialized as 
