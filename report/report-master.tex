...
\tlaplus enables the user to define complex variable with expressions, our channel can be considered folded complex variable declarations with controlled access through the channel functions.
